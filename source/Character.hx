...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('diego','shared',true);
				frames = tex;
				animation.addByPrefix('danceLeft', 'diego dance left', 24, false);
				animation.addByPrefix('danceRight', 'diego dance right', 24, false);
				animation.addByPrefix('singUP', 'diego up', 24, false);
				animation.addByPrefix('singRIGHT', 'diego right', 24, false);
				animation.addByPrefix('singDOWN', 'diego down', 24, false);
				animation.addByPrefix('singLEFT', 'diego lefft', 24, false);
				animation.addByPrefix('hey', 'diego hey', 24, false);
